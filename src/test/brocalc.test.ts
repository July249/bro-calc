...
describe('add function', () => {
  ...
  it('even the argument of add function is negative number, it should be calculated correctly like a subtraction', () => {
    ...
    const x5 = new BroCalc(-0.0000000001)
    const x6 = new BroCalc(0.000000000123456789)
    expect(x5.add(x6)).toMatchObject({ d: [2, 3456789], e: -18, s: 1 })
    expect(x5.add(x6).toString()).toBe('0.000000000023456789')

    const x7 = new BroCalc(-0.0000000001)
    const x8 = new BroCalc(0.123456789)
    expect(x7.add(x8)).toMatchObject({ d: [123, 4567889], e: -10, s: 1 })
    expect(x7.add(x8).toString()).toBe('0.1234567889')
  })
  ...
  it('test', () => {
    const p = new BroCalc('14400000000000000')
    const q = new BroCalc('100000010000000')
    expect(p.add(q)).toMatchObject({ d: [145, 1, 0], e: 0, s: 1 })
  })
})
...
describe('mul function', () => {
  ...
  it('even the argument of mul function is over the 2^53 - 1, it should be calculated correctly', () => {
    ...
    // const p = new BroCalc(102734461911601)
    // const q = new BroCalc(80756122400245)
    // const r = new BroCalc(-80756122400245)
    // expect(p.sub(q)).toMatchObject({
    //   d: [2197833, 9511356],
    //   e: 0,
    //   s: 1,
    // })
    // expect(p.sub(q).toString()).toBe('21978339511356')
    // expect(p.add(r).toString()).toBe('21978339511356')
